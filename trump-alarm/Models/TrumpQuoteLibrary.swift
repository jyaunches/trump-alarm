...
class TrumpQuoteLibrary: NSObject {
    let spewQuotes = [
        ...
        TrumpQuote(content: SoundBiteContent.meganKelly, audioFile: "meg-kelly-blood.wav", identifier: "megan-kelly-blood"),
        TrumpQuote(content: SoundBiteContent.nastyWoman, audioFile: "nasty-woman.wav", identifier: "nasty_woman"),
