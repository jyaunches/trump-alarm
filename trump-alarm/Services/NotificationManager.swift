...
class NotificationManager: NSObject, UNUserNotificationCenterDelegate {
    ...
    func spew() {
        schedule(quote: getRandomQuote(), interval: 1)
        schedule(quote: getRandomQuote(), interval: 5)
        schedule(quote: getRandomQuote(), interval: 10)
        schedule(quote: getRandomQuote(), interval: 15)
    }
